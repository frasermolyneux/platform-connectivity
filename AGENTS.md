# AGENTS.md — platform-connectivity

Repository `platform-connectivity` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
